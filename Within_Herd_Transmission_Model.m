...
Ntrials=100000; %No. of simulations
Ndays=40; %No. of days
dt=1/24; %Time interval for calculating shedding levels

dataset=0; %Parameter dataset - 0=priors, 1-5=posterior from farms 1-5, 6= no env. size, farm 1
...
[ParVp, ParTr, Ni0prior]=LoadParameters(dataset); 
...
while k<=Ntrials    
    ...
    [VP, Ti, samp(k)]=ViralProfile(ParVp,N,Ndays,dt); %Create the viral profile of all animals
